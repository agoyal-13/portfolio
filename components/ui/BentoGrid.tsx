...
import { blockchainLists, webLists, backendLists } from "@/data";
...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    const text = "ankitgoyaljmi@gmail.com";
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {/* Tech stack list div */}
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:mt-10 lg:-right-2 lg:left-80">
              {/* tech stack lists */}
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-5">
                {blockchainLists.map((item, i) => (
                  <span
                    key={i}
